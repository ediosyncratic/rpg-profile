...
<h1>{$username} :: Profile Options</h1>
...
<form action="details.php" method="post">
  ...
  <div class="inputholder"><input type="text" class="quick" name="email" value="{$email}" /> Email address.</div>
  <div class="inputholder"><input type="text" class="quick" name="slength" value="{$slength}" /> Session length, in minutes.</div>
  <p>
