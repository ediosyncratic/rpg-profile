<!--
  ...
  RPG Web Profiler (tm) template file.
  ...
  **
  ...
  Defines the license agreement for using RPG Web Profiler and any site
  specific terms of use policies. You should modify this file by
  adding/modifying sections to reflect your site's specific policies.
-->

<h1>RPG Web Profiler Legal Information</h1>

<div id="contents">
  <b>Contents</b>
  <ol>
    <li><a href="#copyright">Statement of Trademark and Copyright</a></li>
    <li><a href="#privacy">Privacy Policy</a></li>
    <li>
      <a href="#terms">Terms of Use</a>
      <ol>
        <li><a href="#terms.intro">Introduction</a></li>
        <li><a href="#terms.changes">Modifications to This Agreement</a></li>
        <li><a href="#terms.liability">Limitations of Liability</a></li>
        <li><a href="#terms.data">Warranty &amp; User Data</a></li>
        <li><a href="#terms.moderation">Conduct &amp; Moderation</a></li>
      </ol>
    </li>
  </ol>
</div>
...
<div id="copyright">
  <h1>Statemark of Trademark and Copyright</h1>
  <p>
    "3EProfiler" and "RPGProfiler" are trademarks owned by Michael J Eggertson. The 3EProfiler program, all supporting documents, images, and other media are copyrighted by Michael J Eggertson.
  </p>
</div>
...
<div id="terms">
  ...
  <h2 id="terms.data">Warranty &amp; User Data</h2>
  <p>
  ...
  <h2 id="terms.moderation">Conduct &amp; Moderation</h2>
  <p>
